// Class: io/quarkus/deployment/steps/AgroalProcessor$build7
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/AgroalProcessor$build7#deploy_0
    RETURN
    ** label2
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/agroal/runtime/AgroalTemplate#addDataSource
    ASTORE 9
    ALOAD 1
