// Class: io/quarkus/deployment/steps/AgroalProcessor$configureRuntimeProperties4
...
(
    ...
    ** label1
    ...
    ALOAD 3
    AASTORE
    NEW io/quarkus/agroal/runtime/AgroalTemplate
    DUP
    // Method descriptor: ()V
    INVOKESPECIAL io/quarkus/agroal/runtime/AgroalTemplate#<init>
    ASTORE 4
    ALOAD 2
    LDC (Integer) 0
    ALOAD 4
    ...
    INVOKEVIRTUAL io/quarkus/agroal/runtime/AgroalTemplate#configureRuntimeProperties
    RETURN
    ** label2
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/AgroalProcessor$configureRuntimeProperties4#deploy_0
    RETURN
    ** label2
