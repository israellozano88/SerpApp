// Class: io/quarkus/deployment/steps/HibernateOrmProcessor$startPersistenceUnits15
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/HibernateOrmProcessor$startPersistenceUnits15#deploy_0
    RETURN
    ** label2
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/hibernate/orm/runtime/HibernateOrmTemplate#startAllPersistenceUnits
    RETURN
    ** label2
