// Class: io/quarkus/deployment/steps/HibernateOrmProcessor$build12
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/hibernate/orm/runtime/HibernateOrmTemplate#initializeJpa
    ASTORE 5
    ALOAD 1
    ...
    INVOKEVIRTUAL io/quarkus/hibernate/orm/runtime/HibernateOrmTemplate#registerPersistenceUnit
    ASTORE 7
    ALOAD 1
    ...
    INVOKEVIRTUAL io/quarkus/hibernate/orm/runtime/HibernateOrmTemplate#initDefaultPersistenceUnit
    ASTORE 8
    ALOAD 1
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/HibernateOrmProcessor$build12#deploy_0
    RETURN
    ** label2
